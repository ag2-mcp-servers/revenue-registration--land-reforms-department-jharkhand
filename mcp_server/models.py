...
class CertificateParameters(BaseModel):
    ...
    final_doc_reg_no: str = Field(
        ..., description='Registration No.', examples=['2019/RANR/1234/BK1/1234']
    )
...
class CertificateParameters1(BaseModel):
    FullName: str = Field(..., description='Full name', examples=['Sunil Kumar'])
    regno: str = Field(..., description='Regitration No', examples=['1'])
    sro_id: str = Field(
        ...,
        description='SRO Name',
        examples=[
            'Barhi,Bokaro,Bundu,Chaibasa,Chakradharpur,Chandil,Chatra,Deoghar,Dhanbad,Dumka,Dumri,Garhwa,Ghatshil'
        ],
    )
    yr: str = Field(..., description='Year', examples=['20XX'])


class RegriiCertificatePostRequest(BaseModel):
...
class RegriiCertificatePostResponse(BaseModel):
...
class RegriiCertificatePostResponse1(BaseModel):
...
class RegriiCertificatePostResponse2(BaseModel):
...
class RegriiCertificatePostResponse3(BaseModel):
...
class RegriiCertificatePostResponse4(BaseModel):
...
class RegriiCertificatePostResponse5(BaseModel):
...
class RegriiCertificatePostResponse6(BaseModel):
